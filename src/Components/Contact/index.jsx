    ...
    <div className="row gy-4">
      <div className="col-md-6">
        <div className="info-item  d-flex align-items-center">
          <i className="icon bi bi-map flex-shrink-0" ><BiMap/></i>
          <div>
            <h3>Our Address</h3>
      ...
      <div className="col-md-6">
        <div className="info-item d-flex align-items-center">
          <i className="icon bi bi-envelope flex-shrink-0" ><BiEnvelope/> </i>
          <div>
            <h3>Email Us</h3>
      ...
      <div className="col-md-6">
        <div className="info-item  d-flex align-items-center">
          <i className="icon bi bi-telephone flex-shrink-0" ><BsFillTelephoneFill/> </i>
          <div>
            <h3>Call Us</h3>
            <p>+1 5589 55488 55</p>
          </div>
      ...
      <div className="col-md-6">
        <div className="info-item  d-flex align-items-center">
          <i className="icon bi bi-share flex-shrink-0" ><IoShareSocial/> </i>
          <div>
            <h3>Opening Hours</h3>
